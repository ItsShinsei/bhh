...
export const fetchUmroh = (type) =>
  get(type ? `/api/umroh?type=${encodeURIComponent(type)}` : "/api/umroh");
export const fetchOffers = () => get("/api/offers");
export const fetchReviews = () => get("/api/reviews");
export const fetchGallery = (cat) =>
  get(cat ? `/api/gallery?category=${cat}` : "/api/gallery");
...
function subtitle(item) {
  ...
  if (item._cat === "cruise" || item.route) return item.route || "";
...
export function renderCard(item, delay = 0) {
  const imgUrl = imageUrl(item.image_url);
  const originalUrl = driveOriginal(item.image_url);
  ...
  const msg =
    item.whatsapp_msg ||
    `Halo! Saya tertarik dengan ${item.name}. Bisa info lebih lanjut?`;
      ...
      <div class="card-img">
        ${
          imgUrl
            ...
            ${originalUrl ? `data-original="${originalUrl}"` : ""}
            onerror="if (this.dataset.original) { this.src=this.dataset.original; this.dataset.original=''; } else { this.parentElement.innerHTML='<div class=card-img-placeholder>🌍</div>'; }" />`
...
export function renderOfferCard(o, delay = 0) {
  const imgUrl = imageUrl(o.image_url);
  const msg =
    o.whatsapp_msg ||
    `Halo! Saya tertarik dengan penawaran ${o.name}. Bisa info lebih lanjut?`;
  return `
  ...
  input.addEventListener("keydown", (e) => {
    ...
    if (e.key === "ArrowDown") {
      ...
      if (activeIndex >= 0 && rows[activeIndex])
        select(rows[activeIndex].dataset.val);
  ...
  domestik: [
    {
      ...
      duration: "5D4N",
      price: "Rp 5.500.000",
      description: "Pura Tanah Lot, sawah Tegalalang, dan sunset di Kuta.",
      image_url:
        "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=600&auto=format&fit=crop",
      badge: "Terlaris",
      whatsapp_msg:
        "Halo! Saya tertarik dengan paket Bali Romantis. Bisa info lebih lanjut?",
    },
    {
      province: "NTB",
      city: "Lombok",
      ...
      price: "Rp 3.900.000",
      description:
        "Air jernih, snorkeling di Gili Trawangan, dan Pantai Senggigi.",
      image_url:
        "https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?w=600&auto=format&fit=crop",
      badge: "💰 Budget",
      whatsapp_msg:
        "Halo! Saya tertarik dengan paket Lombok & Gili. Bisa info lebih lanjut?",
    },
    {
      ...
      price: "Rp 9.500.000",
      description:
        "Surga bawah laut terbaik dunia. Diving dan snorkeling paling kaya.",
      image_url:
        "https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?w=600&auto=format&fit=crop",
      badge: "🤿 Diving",
      whatsapp_msg:
        "Halo! Saya tertarik dengan paket Raja Ampat. Bisa info lebih lanjut?",
    },
  ],
  inter: [
    {
      ...
      duration: "7D6N",
      price: "Rp 18.000.000",
      description: "Musim bunga sakura di Tokyo, Kyoto, dan Osaka.",
      image_url:
        "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=600&auto=format&fit=crop",
      badge: "🌸 Musiman",
      whatsapp_msg:
        "Halo! Saya tertarik dengan paket Jepang Sakura. Bisa info lebih lanjut?",
    },
    {
      country: "Korea Selatan",
      city: "Seoul",
      name: "Korea Autumn Tour",
      duration: "6D5N",
      price: "Rp 14.000.000",
      description: "Seoul, Jeju, dan Nami Island berbalut daun musim gugur.",
      image_url:
        "https://images.unsplash.com/photo-1480796927426-f609979314bd?w=600&auto=format&fit=crop",
      badge: "🔥 Hot",
      whatsapp_msg:
        "Halo! Saya tertarik dengan paket Korea Autumn. Bisa info lebih lanjut?",
    },
    {
      country: "Singapura",
      city: "Singapura",
      name: "Singapura Weekend",
      duration: "3D2N",
      price: "Rp 7.800.000",
      description:
        "Gardens by the Bay, Marina Bay Sands, dan Universal Studios.",
      image_url:
        "https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=600&auto=format&fit=crop",
      badge: "",
      whatsapp_msg:
        "Halo! Saya tertarik dengan paket Singapura Weekend. Bisa info lebih lanjut?",
    },
  ],
  cruise: [
    {
      route: "Singapura → Malaysia → Thailand",
      name: "Cruise Asia Selatan",
      duration: "5 Hari 4 Malam",
      price: "Rp 12.000.000",
      description:
        "Berlayar dari Singapura ke Penang dan Phuket. Nikmati 3 negara.",
      image_url:
        "https://images.unsplash.com/photo-1548194099-bed76927b52e?w=600&auto=format&fit=crop",
      badge: "🔥 Populer",
      whatsapp_msg:
        "Halo! Saya tertarik dengan Cruise Asia Selatan. Bisa info lebih lanjut?",
    },
    {
      route: "Barcelona → Italia → Yunani",
      name: "Cruise Mediterania",
      duration: "12 Hari 11 Malam",
      price: "Rp 48.000.000",
      description: "Pelayaran ikonik — Barcelona, Roma, Santorini, dan Athena.",
      image_url:
        "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&auto=format&fit=crop",
      badge: "🌟 Mewah",
      whatsapp_msg:
        "Halo! Saya tertarik dengan Cruise Mediterania. Bisa info lebih lanjut?",
    },
  ],
  umroh: [
    {
      ...
      price: "Rp 25.000.000",
      description:
        "Hotel bintang 3 di Mekkah dan Madinah. Termasuk pembimbing bersertifikat.",
      image_url:
        "https://images.unsplash.com/photo-1591604466107-ec97de577aff?w=600&auto=format&fit=crop",
      badge: "Terjangkau",
      whatsapp_msg:
        "Halo! Saya tertarik dengan Umroh Reguler. Bisa info lebih lanjut?",
    },
    {
      package_type: "Plus",
      ...
      duration: "14 Hari",
      price: "Rp 42.000.000",
      description: "Ibadah umroh + city tour Istanbul, Cappadocia, dan Konya.",
      image_url: "",
      badge: "✨ Plus Tour",
      whatsapp_msg:
        "Halo! Saya tertarik dengan Umroh Plus Turki. Bisa info lebih lanjut?",
    },
    {
      package_type: "Premium",
      name: "Umroh Premium Bintang 5",
      duration: "10 Hari",
      price: "Rp 65.000.000",
      description:
        "Hotel bintang 5 persis di depan Masjidil Haram dan Masjid Nabawi.",
      image_url: "",
      badge: "⭐ Premium",
      whatsapp_msg:
        "Halo! Saya tertarik dengan Umroh Premium. Bisa info lebih lanjut?",
    },
  ],
  offers: [
    {
      name: "Paket Bulan Madu",
      description:
        "Upgrade vila + makan malam romantis untuk pasangan yang booking 5D4N atau lebih.",
      image_url:
        "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=600&auto=format&fit=crop",
      badge: "🔥 Spesial",
      whatsapp_msg: "Halo! Saya tertarik dengan Paket Bulan Madu. Bisa info?",
    },
    {
      name: "Anak Gratis Pergi",
      description:
        "Anak bawah 5 tahun gratis. Anak 6–12 tahun diskon 30% untuk paket domestik.",
      image_url: "",
      badge: "Keluarga",
      whatsapp_msg: "Halo! Saya ingin tanya promo Anak Gratis. Bisa info?",
    },
    {
      name: "Tour Group & Corporate",
      description:
        "Outing kantor 10+ orang dengan harga spesial dan itinerari custom.",
      image_url: "",
      badge: "Group",
      whatsapp_msg: "Halo! Saya ingin tanya paket Group/Corporate. Bisa info?",
    },
  ],
  reviews: [
    {
      name: "Siti Rahayu",
      rating: 5,
      text: "Pelayanannya luar biasa! Perjalanan ke Jepang kami diurus sangat profesional. Pasti pakai BHH lagi!",
      date: "Maret 2025",
    },
    {
      name: "Budi Santoso",
      rating: 5,
      text: "Paket umrohnya sangat memuaskan. Hotel dekat Masjidil Haram dan pembimbing berpengalaman. Terima kasih!",
      date: "Februari 2025",
    },
    {
      name: "Dewi Lestari",
      rating: 5,
      text: "Honeymoon ke Bali jadi sempurna berkat BHH. Rekomendasi tepat dan harga kompetitif!",
      date: "April 2025",
    },
  ],
};
...
export function renderPager(container, page, totalPages, onChange) {
  ...
  container.querySelector('[data-pg="prev"]').onclick = () =>
    onChange(page - 1);
  container.querySelector('[data-pg="next"]').onclick = () =>
    onChange(page + 1);
}
