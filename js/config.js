...
export const API_BASE = "https://bhh-api.beehappyholiday.workers.dev";
...
export const WA_DEFAULT =
  "Halo Bee Happy Holiday! Saya ingin tanya tentang paket wisata.";
...
export const COMPANY = {
  ...
  address:
    "Jl. Peneleh VI No.5, Peneleh, Kec. Genteng, Surabaya, Jawa Timur 60274",
...
export const SOCIALS = {
  instagram: {
    label: "Instagram",
    handle: "@beehappyholiday",
    url: "https://www.instagram.com/bee_happyholiday",
  },
  tiktok: {
    label: "TikTok",
    handle: "@beehappyholiday",
    url: "https://www.tiktok.com/@bee_happyholiday",
  },
  facebook: {
    label: "Facebook",
    handle: "Bee Happy Holiday",
    url: "https://web.facebook.com/beehappy.holiday",
  },
  x: {
    label: "X (Twitter)",
    handle: "@beehappyholiday",
    url: "https://x.com/beehappyholiday",
  },
  youtube: {
    label: "YouTube",
    handle: "@beehappyholiday",
    url: "https://youtube.com/@beehappyholiday",
  },
  email: {
    label: "Email",
    handle: "beehappyholiday@gmail.com",
    url: "mailto:beehappyholiday@gmail.com",
  },
};
...
function driveFileId(url) {
  const match = String(url).match(
    /drive\.google\.com\/(?:file\/d\/|open\?|uc\?|thumbnail\?)(?:[^#]*?&)?id=([a-zA-Z0-9_-]+)|drive\.google\.com\/file\/d\/([a-zA-Z0-9_-]+)/,
  );
